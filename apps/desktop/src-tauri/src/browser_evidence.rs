...
mod tests {
    ...
    fn instrumentation_is_bounded_and_omits_sensitive_request_material() {
        ...
        assert!(!BROWSER_EVIDENCE_SCRIPT.contains(&["request", "headers"].join(".")));
        assert!(!BROWSER_EVIDENCE_SCRIPT.contains(&["response", "text"].join(".")));
        assert!(!BROWSER_EVIDENCE_SCRIPT.contains(&["response", "json"].join(".")));
        ...
        assert!(!BROWSER_EVIDENCE_SCRIPT.contains(&["url", "search"].join(".")));
        assert!(!BROWSER_EVIDENCE_SCRIPT.contains(&["url", "hash"].join(".")));
